...
MLUsageExamples contains small example ECL programs that illustrate how to
use the functions and macros in the Machine Learning (ML) library. Each of these
examples are stand-alone. To execute any of them, you only need the ML library in your
repository.
...
The folders in this bundle is organized like the ML library's folder structure. For example
